...
def main():
    ...
    def user_input_features() -> pd.DataFrame:
        ...
        phys_health = st.number_input("For how many days during the past 30 days was"
                                              " your physical health not good?", 0, 30, 0)
        ment_health = st.number_input("For how many days during the past 30 days was"
        ...
        diff_walk = st.selectbox("Do you have serious difficulty walking"
